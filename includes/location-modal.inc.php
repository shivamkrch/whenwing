    ...
    <div class="modal-dialog mt-5">
        <div class="modal-content">
            ...
            <div class="modal-header bg-light shadow">
              <h5 class="modal-title"><i class="fas fa-map-marker-alt text-danger ml-2 mr-2"></i> Select Location</h5>
            ...
            <div class="modal-footer bg-light">
                <button type="button" class="btn btn-danger">Next <i class="fas fa-arrow-right ml-2"></i></button>
            </div>
        </div>
    </div>
</div>
...
function autocomplete() {
    var currentFocus;
    var inp = document.querySelector('#userLoc');
    inp.addEventListener("input", function(e) {
      ...
      if(val.length < 4){
        $.get("../api/area_pincodes.php",{ q : val },
          function (res) {
            areas = res;
          },'json');
      }
      ...
      for (i = 0; i < areas.length; i++) {
        var loc = areas[i].toUpperCase().search(val.toUpperCase());
        if(loc != -1){
