...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2019 at 07:21 PM
...
INSERT INTO `ww_provider` (`prov_id`, `prov_name`, `age`, `addr`, `profession`, `contact`, `workexp`, `prov_record`, `about`, `speciality`, `photo_id`, `service_types`, `appliance_types`, `price`, `reg_date`, `prov_active_status`) VALUES
...
(22, 'The SKC', 20, 'Muzaffarpur', 'AC service Repair and Installation', '98565656566', 'none', '', 'mcb jhhhjn jhhnn  jhd54ryh jkhfn jg', 'best in job', '', 'repair,gas filling', 'window AC', 300, '0000-00-00 00:00:00', 1),
(23, 'A8A Appliances', 21, 'Delhi', 'AC Service Repair and installation', '9665566566', '2 years', 'repaired 20 ACs in last 2 months', 'dask kajsd kasbdsd qjewq', 'repairs all kind of ACs', '', 'installation,un-installation', 'window AC,split AC', 250, '0000-00-00 00:00:00', 0),
(24, 'A8a appliances', 28, 'Shaniganj', 'Referigerator repair', '8465131656', '5 years', 'None', 'Best in the area', 'Repairs all kinnds of referigerators.', '', 'maintenance', 'single door,double door', 400, '2019-04-02 18:53:10', 0);
